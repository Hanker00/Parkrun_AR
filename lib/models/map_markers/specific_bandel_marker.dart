...
class Bandel_1_marks {
  static List<MapMarker> get mapMarker => [
        DirectionMarker(
            "Rakt fram 3",
...
class Bandel_2_marks {
  static List<MapMarker> get mapMarker => [
        ...
        DirectionMarker.right("Höger",
            "Deltagarna ska fortsätta svagt åt höger", 12.0446193, 57.703847),
        DirectionMarker.right("Höger",
            "Deltagarna ska fortsätta svagt åt höger", 12.0447855, 57.7034586)
      ];
}

class Bandel_3_marks {
  static List<MapMarker> get mapMarker => [
