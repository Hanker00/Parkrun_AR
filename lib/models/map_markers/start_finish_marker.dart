...
class StartFinishMarker extends MapMarker {
  ...
  StartFinishMarker(title, String description, double startLatitude, double startLongitude) : super(markerIcon: Icons.sports_score, title:title, description:description, startLatitude: startLatitude, startLongitude: startLongitude);
}